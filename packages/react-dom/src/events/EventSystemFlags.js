...
export const IS_EVENT_HANDLE_NON_MANAGED_NODE = 1;  //000001
export const IS_NON_DELEGATED = 1 << 1;             //000010
export const IS_CAPTURE_PHASE = 1 << 2;             //000100
export const IS_PASSIVE = 1 << 3;                   //001000
export const IS_LEGACY_FB_SUPPORT_MODE = 1 << 4;    //010000
